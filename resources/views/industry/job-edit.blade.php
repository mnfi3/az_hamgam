    ...
    <div class="container my-4 " id="side-list">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                ...
                <h5 style="text-align: right;color: #ffffff" class="py-3">:  ویرایش فرصت شغلی </h5>
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{url('/industry/job/update')}}" method="post" enctype="multipart/form-data" class="px-3" style="direction: rtl;font-family: Vazir">
                            @csrf
