        ...
        <div class="row mt-5 pt-4 " >
            ...
            <div class="col-md-8 " style="">
                <div class="d-flex flex-row justify-content-center">
                    <img src="{{asset($visit->image)}}" alt="" style=" max-width: 650px;max-height: 300px " class="">
                </div>
                <h3 class="my-2 text-right p-3 ">{{$visit->title}}</h3>

                <p class="my-2 text-right p-3 ">
                    @php echo $visit->description; @endphp
                </p>
                <p class="my-2 text-right p-1 ">
                    مکان بازدید : {{$visit->time_place}}
                </p>
                @php($date = new \App\Http\Controllers\Util\PDate())
                <p class="my-2 text-right p-1 ">
                    زمان : {{$date->toPersian($visit->deadline, 'Y/m/d')}}
                </p>
                ...
                <div class="d-flex flex-row-reverse flex-wrap">
                    <a href="{{url('/gathering/visit-industries/register', $visit->id)}}">
