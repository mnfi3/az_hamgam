    ...
    <div class="container my-4 " id="side-list">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <h5 class="text-white text-right mb-2" style="font-family: Vazir">لیست دانشجویان {{$workshop->title}}</h5>
                    ...
                    <tr>
                        ...
                        @if(strlen($student->studentPivotWorkshops()->where('workshop_id', '=', $workshop->id)->first()->mark) == 0)
                            <td style="width: 290px">
                                <form action="{{url('/master/workshop-detalis/add-mark')}}" method="post"  class="px-3" style="direction: rtl;font-family: Vazir">
                                    @csrf
