    ...
    <div class="container my-4 " id="side-list">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h5 class="text-white text-right my-4" style="font-family: Vazir">دوره های آزاد</h5>
                ...
                <table class="table table-striped text-center usr-table" id="کاربران" style="direction: rtl;font-family: Vazir">
                    ...
                    @foreach($courses as $course)
                        <tr>
                            <td scope="row">{{++$i}}</td>
                            <td>{{$course->title}}</td>
                            <td>{{$date->toPersian($course->time, 'Y/m/d')}}</td>
                            <td><a href="{{url('/master/free-course-detalis', $course->id)}}" class="custom-btn text-center m-2 p-2" style="max-width: 110px" >مشاهده </a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
