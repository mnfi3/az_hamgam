    ...
    <div class="container my-4 " id="side-list">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <h5 class="text-white text-right mb-2" style="font-family: Vazir"> جزییات فرصت شغلی <i>{{$ad->title}}</i></h5>
            </div>
                        ...
                        <table class="table table-striped text-center" style="direction: rtl;font-family: Vazir" id="table">
                            ...
                            @foreach($ad->userJobAd()->orderBy('id', 'desc')->get() as $user_jobad)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/admin/job-ads/details/resume-download', $user_jobad->id)}}">
