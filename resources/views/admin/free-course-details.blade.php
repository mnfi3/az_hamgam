            ...
            <div class="col-md-6 col-sm-12 ">
                ...
                <form action="{{url('/admin/free-course/edit')}}" method="post" enctype="multipart/form-data" class="px-3" style="direction: rtl;font-family: Vazir">
                    ...
                    <div class="form-group row py-4">
                        ...
                        <input type="text" id="title" required=""
                               class="form-control col-md-10 "  name="hour" placeholder="ساعت" value="{{$course->hour}}">
                    </div>

                    <div class="form-group row py-4">
                        <label class="col-md-2 col-form-label " style="">مدت</label>
                        <input type="number" id="title" required=""
                               class="form-control col-md-10 "  name="duration" placeholder="ساعت" value="{{$course->duration}}">
                    </div>

                    <div class="form-group row py-4">
                        <label class="col-md-2 col-form-label " style=""> ظرفیت کارگاه</label>
                        <input type="number" id="title" required=""
                               class="form-control col-md-10 "  name="capacity" placeholder="ظرفیت" value="{{$course->capacity}}">
                    </div>
                    <div class="form-group row py-4">
                        <label class="col-md-2 col-form-label " style=""> هزینه کارگاه</label>
                        <input type="number" id="title" required=""
                               class="form-control col-md-10 "  name="price" value="{{$course->price}}" placeholder="هزینه (تومان)">
                    </div>
